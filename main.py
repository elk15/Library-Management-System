...
class Book:
    ...
    def __init__(self, title, author, pages, cover, published_date, description, isbn, amount, id):
        ...
        id              unique identification code generated by the library system (eg. B01)
        """
        self.title = title
        self.genres = []
        self.author = author
...
class Library:
    ...
    def main(self):
        self.import_books()
        # self.add_new_book( ["Fairytale"], "J. M. Barrie", 234, "http://books.google.com/books/content?id=ogjljqn1R2kC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api", "2001-10", "The adventures of Peter Pan, the boy who would not grow up.", "9780689830785", 20)
        # print(not self.find_book_with_isbn('435346'))
